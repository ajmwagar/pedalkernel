...
// Tests for element types live in the pedalkernel crate (require model DB + std).
// See pedalkernel/src/elements/mod.rs for the canonical test suite.
...
mod tests {
    ...
    // ─────────────────────────────────────────────────────────────────────
    // Note: Legacy BjtNpnRoot/BjtPnpRoot unit tests have been removed.
    // BJT behaviour is now covered by integration tests (tests/bjt_*.rs)
    // via the BjtTwoPort Gummel-Poon 2-port grouped solver path.
    // ─────────────────────────────────────────────────────────────────────
