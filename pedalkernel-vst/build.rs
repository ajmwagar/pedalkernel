...
fn main() {
    ...
    for (exists, pedals_dir) in [(pro_exists, &pro_pedals_dir), (pro_top_exists, &pro_pedals_top_dir), (main_exists, &main_pedals_dir), (main_synths_exists, &main_synths_dir)] {
        if exists {
    ...
    if !pro_exists && !pro_top_exists && !main_exists && !main_synths_exists {
        ...
        // Collect from pro (pedals/real/) and main repos
