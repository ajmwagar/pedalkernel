...
impl ImpedanceModel {
    ...
    /// ~1MOhm input, negligible capacitance.
    ...
    /// ~10kOhm input — significantly loads the source.
    ...
    /// ~1kOhm output — drives cables and next pedal easily.
    ...
    /// ~50kOhm-100kOhm — susceptible to cable loading.
    ...
    /// Models a typical single-coil pickup: ~7kOhm DC, ~100pF cable loading
...
mod tests {
    ...
    fn interstage_fuzz_face_loading() {
        ...
        let load = ImpedanceModel::low_z_input();
        let loading = InterstageLoading::new(source, load, 48000.0);
    ...
    fn cable_model_cutoff_frequency() {
        ...
        assert!(
            ...
            "20ft cable with 7kOhm source: fc={fc:.0} Hz"
        );
    }
