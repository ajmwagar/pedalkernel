...
fn triode_stage_is_sample_rate_consistent() {
    ...
    let out48 =
        compile_test_pedal_and_process("triode_clean.pedal", &input48, 48_000.0, &[]);
    let out96 =
        compile_test_pedal_and_process("triode_clean.pedal", &input96, 96_000.0, &[]);
