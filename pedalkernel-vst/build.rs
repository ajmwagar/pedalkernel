...
fn main() {
    ...
    for (exists, pedals_dir) in [(pro_exists, &pro_pedals_dir), (main_exists, &main_pedals_dir)] {
        if exists {
    ...
    if !pro_exists && !main_exists {
        ...
        output.push_str("#[cfg(any(feature = \"pro-guitar\", feature = \"pro-bass\", feature = \"pro-amps\"))]\n");
